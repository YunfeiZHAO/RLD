...
def plot_flow(flowmodel,n=2000):
    ...
    _,axs=plt.subplots(n_plots,n_plots,figsize=(50,50))
    a=0
    b=0
    for d in samples:
        name=list(d.keys())[0]
...
if __name__=="__main__":
    ...
    conv1 = [Conv1() for _ in range(depth)]
    ...
    n_samples=5000
    torch.save(model.state_dict(),"./model_circles.txt")
    ...
    ax1.scatter(x[:,0], x[:,1], c='b', s=5, alpha=0.5)
